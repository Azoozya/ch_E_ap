use crate::{SQL_ROOT,SQL_AUTH,SQL_AUTH_USER,SQL_REGISTER,SQL_REGISTER_USER};
use crate::sql::transaction::{CHEAPTransaction};
use crate::sql::schema::{User,Challenge,Cookie,CHEAPTable};
...
pub fn demo() {
    ...
    let drops = vec![ User::prepare_up_table(),Cookie::prepare_up_table(),Challenge::prepare_up_table()];
    // () means "no params"
    let params = vec![ (), (), ()];

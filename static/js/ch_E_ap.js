...
* @returns {number}
*/
export function wasm_new_buffer() {
    const ret = wasm.wasm_new_buffer();
    return ret;
}

/**
* @param {number} wasm_buffer
* @param {number} len
*/
export function wasm_clean_buffer(wasm_buffer, len) {
    wasm.wasm_clean_buffer(wasm_buffer, len);
}

/**
* @returns {number}
*/
export function get_WASM_MEMORY_BUFFER_SIZE() {
    const ret = wasm.get_WASM_MEMORY_BUFFER_SIZE();
    return ret >>> 0;
}
...
* @param {number} wasm_buffer
*/
export function wasm_generate_keypair_ed25519(wasm_buffer) {
    wasm.wasm_generate_keypair_ed25519(wasm_buffer);
}

/**
* @param {number} wasm_buffer
*/
export function wasm_generate_keypair_ecdsa(wasm_buffer) {
    wasm.wasm_generate_keypair_ecdsa(wasm_buffer);
}

/**
* @param {number} wasm_buffer
*/
export function wasm_generate_keypair_rsa(wasm_buffer) {
    wasm.wasm_generate_keypair_rsa(wasm_buffer);
}

/**
* @param {number} wasm_buffer
*/
export function wasm_sign(wasm_buffer) {
    wasm.wasm_sign(wasm_buffer);
}
...
* @returns {boolean}
*/
export function wasm_verify(wasm_buffer) {
    const ret = wasm.wasm_verify(wasm_buffer);
    return ret !== 0;
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('/wasm/ch_E_ap_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_alert_183c1b0c8e6a7132 = function(arg0, arg1) {
